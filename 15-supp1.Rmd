...
![img](//upload-images.jianshu.io/upload_images/7178691-43452f2f413e5094.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/700)
...
![img](//upload-images.jianshu.io/upload_images/7178691-b8996bf943a06ab9.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/700)
...
![img](//upload-images.jianshu.io/upload_images/7178691-95bbca6d8d04e4c7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/700)
...
本章的后面，我会介绍使用Numba（[http://numba.pydata.org/](https://link.jianshu.com?t=http%3A%2F%2Fnumba.pydata.org%2F)），创建快速Python ufuncs。
...
![img](//upload-images.jianshu.io/upload_images/7178691-970f54f58b6b3356.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/700)
...
Numba是一个开源项目，它可以利用CPUs、GPUs或其它硬件为类似NumPy的数据创建快速函数。它使用了LLVM项目（[http://llvm.org/](https://link.jianshu.com?t=http%3A%2F%2Fllvm.org%2F)），将Python代码转换为机器代码。
...
我建议你学习Numba的线上文档（[http://numba.pydata.org/](https://link.jianshu.com?t=http%3A%2F%2Fnumba.pydata.org%2F)）。下一节介绍一个创建自定义Numpy ufunc对象的例子。
...
如果单用NumPy无论如何都达不到所需的性能指标，就可以考虑一下用C、Fortran或Cython（等下会稍微介绍一下）来编写代码。我自己在工作中经常会用到Cython（[http://cython.org](https://link.jianshu.com?t=http%3A%2F%2Fcython.org)），因为它不用花费我太多精力就能得到C语言那样的性能。
